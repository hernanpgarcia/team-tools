        ...
        for filename in os.listdir(template_dir):
            if filename.endswith(".html"):
                ...
                for pattern in problematic_patterns:
                    ...
                    if matches:
                        pytest.fail(
                            f"Template {filename} contains problematic formatting: {matches}"
                        )
        ...
        for filename in os.listdir(template_dir):
            if filename.endswith(".html"):
                ...
                if problematic_percentage:
                    pytest.fail(
                        f"Template {filename} has incorrect percentage formatting: {problematic_percentage}"
                    )
...
class TestTemplateRendering:
        ...
        for test_case in test_cases:
            try:
                rendered = template.render(
                    method=test_case["method"], **test_case["data"]
                )
                assert rendered is not None
                ...
                pytest.fail(
                    f"Std calculator results template failed to render for method {test_case['method']}: {e}"
                )
    ...
    def test_error_template_rendering(self, jinja_env):
        ...
        data = {"error_message": "Test error message", "back_url": "/test-url"}
    ...
    def test_templates_have_title(self, jinja_env):
        ...
        for template_name in template_files:
            try:
                ...
                ), f"Template {template_name} has empty title"
    ...
    def test_templates_have_proper_html_structure(self, jinja_env):
        ...
        for template_name in template_files:
            try:
                ...
                ), f"Template {template_name} missing html tag"
                assert (
                    soup.head is not None
                ), f"Template {template_name} missing head tag"
                assert (
                    soup.body is not None
                ), f"Template {template_name} missing body tag"
...
class TestTemplateConsistency:
    ...
    def test_all_templates_extend_base(self, jinja_env):
        ...
        extending_templates = [
            ...
            "std_calculator_results.html",
            "error.html",
            "fixed_horizon_form.html",
            "msprt_form.html",
            "std_calculator_form.html",
        ]
        ...
        for template_name in extending_templates:
            ...
            if os.path.exists(template_path):
                ...
                ), f"Template {template_name} should extend base.html"
            ...
            if os.path.exists(template_path):
                ...
                for css_class in expected_classes:
                    if css_class in [
                        ...
                        ), f"Template {template_name} missing expected class {css_class}"
