...
class TestMSPRTCalculator:
    ...
    def test_valid_msprt_calculation(self, client):
        ...
        response = client.post('/calculate-msprt', data={
            'baseline_mean': '100',
            'baseline_std': '20',
            'std_known': 'known',
            'improvement_type': 'relative',
...
class TestStdCalculator:
    ...
    def test_std_from_data_points(self, client):
        ...
        response = client.post('/calculate-std-from-data', data={
    ...
    def test_std_from_range(self, client):
        ...
        response = client.post('/calculate-std-from-range', data={
            'min_val': '10',
            'max_val': '30',
    ...
    def test_std_from_percentiles(self, client):
        ...
        response = client.post('/calculate-std-from-percentiles', data={
            'p25': '25',
            'p50': '50',
            'p75': '75'
        })
    ...
    def test_conversion_rate_std_historical(self, client):
        ...
        response = client.post('/calculate-conversion-rate-std', data={
