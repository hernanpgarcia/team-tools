...
class TestPerformance:
    ...
    def test_sample_size_with_varying_parameters(self):
        ...
        for baseline_mean, baseline_std, improvement_type, improvement_value, power, alpha in test_cases:
            start_time = time.time()
    ...
    def test_sample_size_performance_property_based(self, baseline_mean, baseline_std, improvement_value, power, alpha):
    ...
    def test_large_dataset_std_calculation(self):
        ...
        for size in dataset_sizes:
            ...
            assert calculation_time < max_time, f"Dataset size {size} too slow: {calculation_time:.4f}s"
...
class TestRegressionTests:
    ...
    def test_sample_size_regression_known_values(self):
        ...
        for test_case in test_cases:
            ...
            assert abs(result['sample_size_per_group'] - test_case['expected_sample_size']) <= 1
    ...
    def test_statistical_properties_regression(self):
        ...
        result_low_power = calculate_sample_size(
            baseline_mean=100, baseline_std=20, improvement_type='relative',
            improvement_value=5, power=0.7, alpha=0.05
        )
        
        result_high_power = calculate_sample_size(
            baseline_mean=100, baseline_std=20, improvement_type='relative',
            improvement_value=5, power=0.9, alpha=0.05
        )
        ...
        result_high_alpha = calculate_sample_size(
            baseline_mean=100, baseline_std=20, improvement_type='relative',
            improvement_value=5, power=0.8, alpha=0.10
        )
        
        result_low_alpha = calculate_sample_size(
            baseline_mean=100, baseline_std=20, improvement_type='relative',
            improvement_value=5, power=0.8, alpha=0.01
        )
